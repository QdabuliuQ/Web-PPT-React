...
<section id="slide" data-bg="#0B1220" data-page-id="page_metrics"
  ...
  <div style="display:flex;align-items:center;gap:14px;margin-bottom:28px;">
    <div data-element="1" data-type="icon"
      ...
      style="width:36px;height:36px;flex-shrink:0;background:#F5B942;border-radius:8px;"></div>
    <div data-element="1" data-type="text"
      ...
      style="font-size:32px;font-family:PingFang SC,sans-serif;font-weight:700;line-height:1.2;color:#FFFFFF;">增长引擎一览</div>
  </div>

  <div data-element="1" data-type="shape" data-shape-type="rect" data-fill="#F5B942" data-opacity="1"
    style="width:48px;height:4px;background:#F5B942;margin-bottom:32px;"></div>

  <div data-element="1" data-type="text"
    data-font-size="16" data-font-family="PingFang SC" data-color="#B8C0CC"
    data-line-height="1.5" data-placement="left-top"
    style="font-size:16px;font-family:PingFang SC,sans-serif;line-height:1.5;max-width:640px;color:#B8C0CC;">
  ...
  <div style="display:flex;gap:20px;">
    ...
    <div style="position:relative;flex:1;height:280px;">
      <div data-element="1" data-type="shape" data-shape-type="roundedRect" data-fill="#FFFFFF"
        style="position:absolute;inset:0;background:#fff;border-radius:16px;box-shadow:0 8px 24px rgba(0,0,0,.06);"></div>
