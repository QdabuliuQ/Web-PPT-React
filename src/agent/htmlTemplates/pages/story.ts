...
export const AGENDA_STEPS = `<section id="slide" data-page-id="{{pageId}}" data-bg="{{background}}" style="width:1000px;height:562.5px;position:relative;overflow:hidden;background:{{background}};box-sizing:border-box;padding:44px 56px;font-family:{{fontTitle}},sans-serif;">
  <div data-element="1" data-type="text" data-font-size="11" data-font-family="{{fontBody}}" data-color="{{accentText}}" data-line-height="1.3" data-placement="left-top" data-z-index="28" translate="no" style="width:200px;font-size:11px;font-family:{{fontBody}},sans-serif;letter-spacing:0.18em;color:{{accentText}};line-height:1.3;z-index:28;">AGENDA</div>
  ...
  <div style="display:flex;flex-direction:column;gap:0;margin-top:36px;">
    <div style="display:flex;gap:16px;align-items:center;padding:14px 0;">
      <div data-element="1" data-type="text" data-font-size="20" data-font-family="{{fontNumeric}}" data-color="{{accentText}}" data-line-height="1" data-placement="left-top" data-bold data-z-index="29" style="width:44px;flex-shrink:0;font-size:20px;font-family:{{fontNumeric}},serif;font-weight:700;color:{{accentText}};line-height:1;z-index:29;font-variant-numeric:tabular-nums;">01</div>
      <div data-element="1" data-type="icon" aria-hidden="true" data-icon-name="{{i1.iconName}}" data-icon-theme="outline" data-fill="{{primary}}" data-stroke-width="3" data-z-index="29" style="width:28px;height:28px;flex-shrink:0;z-index:29;"></div>
      <div data-element="1" data-type="text" data-font-size="18" data-font-family="{{fontTitle}}" data-color="{{textOnLight}}" data-line-height="1.3" data-placement="left-top" data-bold data-z-index="30" style="flex:0 0 180px;min-width:0;font-size:18px;font-family:{{fontTitle}},serif;font-weight:700;color:{{textOnLight}};line-height:1.3;z-index:30;text-wrap:balance;overflow-wrap:anywhere;">{{i1.title}}</div>
    ...
    <div data-element="1" data-type="shape" data-shape-type="rect" data-fill="{{hairline}}" data-z-index="8" style="width:888px;height:1px;background:{{hairline}};z-index:8;"></div>
    <div style="display:flex;gap:16px;align-items:center;padding:14px 0;">
      <div data-element="1" data-type="text" data-font-size="20" data-font-family="{{fontNumeric}}" data-color="{{accentText}}" data-line-height="1" data-placement="left-top" data-bold data-z-index="29" style="width:44px;flex-shrink:0;font-size:20px;font-family:{{fontNumeric}},serif;font-weight:700;color:{{accentText}};line-height:1;z-index:29;font-variant-numeric:tabular-nums;">02</div>
      <div data-element="1" data-type="icon" aria-hidden="true" data-icon-name="{{i2.iconName}}" data-icon-theme="outline" data-fill="{{primary}}" data-stroke-width="3" data-z-index="29" style="width:28px;height:28px;flex-shrink:0;z-index:29;"></div>
    ...
    <div style="display:flex;gap:16px;align-items:center;padding:14px 0;">
      ...
      <div data-element="1" data-type="icon" aria-hidden="true" data-icon-name="{{i3.iconName}}" data-icon-theme="outline" data-fill="{{primary}}" data-stroke-width="3" data-z-index="29" style="width:28px;height:28px;flex-shrink:0;z-index:29;"></div>
    ...
    <div style="display:flex;gap:16px;align-items:center;padding:14px 0;">
      ...
      <div data-element="1" data-type="icon" aria-hidden="true" data-icon-name="{{i4.iconName}}" data-icon-theme="outline" data-fill="{{primary}}" data-stroke-width="3" data-z-index="29" style="width:28px;height:28px;flex-shrink:0;z-index:29;"></div>
...
export const PROBLEM_SLASH = `<section id="slide" data-page-id="{{pageId}}" data-bg="{{background}}" style="width:1000px;height:562.5px;position:relative;overflow:hidden;background:{{background}};box-sizing:border-box;font-family:{{fontTitle}},sans-serif;">
  ...
  <div data-element="1" data-type="text" data-font-size="11" data-font-family="{{fontBody}}" data-color="{{accentOnPrimary}}" data-line-height="1.3" data-placement="left-top" data-z-index="30" translate="no" style="position:absolute;left:56px;top:44px;width:300px;font-size:11px;font-family:{{fontBody}},sans-serif;letter-spacing:0.18em;color:{{accentOnPrimary}};line-height:1.3;z-index:30;">THE PROBLEM</div>
  <div data-element="1" data-type="text" data-font-size="32" data-font-family="{{fontTitle}}" data-color="{{textOnDark}}" data-line-height="1.22" data-placement="left-top" data-bold data-z-index="31" style="position:absolute;left:56px;top:120px;width:300px;font-size:32px;font-family:{{fontTitle}},serif;font-weight:700;color:{{textOnDark}};line-height:1.22;z-index:31;text-wrap:balance;overflow-wrap:anywhere;">{{title}}</div>
...
export const SOLUTION_FLOW = `<section id="slide" data-page-id="{{pageId}}" data-bg="{{background}}" style="width:1000px;height:562.5px;position:relative;overflow:hidden;background:{{background}};box-sizing:border-box;padding:44px 56px;font-family:{{fontTitle}},sans-serif;">
  ...
  <div data-element="1" data-type="text" data-font-size="32" data-font-family="{{fontTitle}}" data-color="{{textOnLight}}" data-line-height="1.2" data-placement="left-top" data-bold data-z-index="30" style="width:888px;margin-top:8px;font-size:32px;font-family:{{fontTitle}},serif;font-weight:700;color:{{textOnLight}};line-height:1.2;z-index:30;text-wrap:balance;overflow-wrap:anywhere;">{{title}}</div>
  <div style="display:flex;gap:28px;margin-top:36px;">
    <div style="flex:1;min-width:0;">
      ...
      <div data-element="1" data-type="icon" aria-hidden="true" data-icon-name="{{s1.iconName}}" data-icon-theme="outline" data-fill="{{primary}}" data-stroke-width="3" data-z-index="29" style="width:28px;height:28px;margin-top:16px;z-index:29;"></div>
      <div data-element="1" data-type="text" data-font-size="44" data-font-family="{{fontNumeric}}" data-color="{{accentText}}" data-line-height="1" data-placement="left-top" data-bold data-z-index="28" style="margin-top:12px;width:80px;font-size:44px;font-family:{{fontNumeric}},serif;font-weight:700;color:{{accentText}};line-height:1;z-index:28;font-variant-numeric:tabular-nums;">01</div>
    ...
    <div style="flex:1;min-width:0;">
      <div data-element="1" data-type="shape" data-shape-type="rect" data-fill="{{secondary}}" data-z-index="10" style="width:100%;height:3px;background:{{secondary}};z-index:10;"></div>
      <div data-element="1" data-type="icon" aria-hidden="true" data-icon-name="{{s2.iconName}}" data-icon-theme="outline" data-fill="{{primary}}" data-stroke-width="3" data-z-index="29" style="width:28px;height:28px;margin-top:16px;z-index:29;"></div>
    ...
    <div style="flex:1;min-width:0;">
      <div data-element="1" data-type="shape" data-shape-type="rect" data-fill="{{secondary}}" data-z-index="10" style="width:100%;height:3px;background:{{secondary}};z-index:10;"></div>
      <div data-element="1" data-type="icon" aria-hidden="true" data-icon-name="{{s3.iconName}}" data-icon-theme="outline" data-fill="{{primary}}" data-stroke-width="3" data-z-index="29" style="width:28px;height:28px;margin-top:16px;z-index:29;"></div>
...
/** Signature: 左配图（圆角+细边框）+ 右解读；图文不重叠以免被 compile 剪掉 */
export const EVIDENCE_SPLIT = `<section id="slide" data-page-id="{{pageId}}" data-bg="{{background}}" style="width:1000px;height:562.5px;position:relative;overflow:hidden;background:{{background}};box-sizing:border-box;padding:44px 56px;font-family:{{fontTitle}},sans-serif;">
  ...
  <div style="display:flex;gap:40px;margin-top:32px;align-items:stretch;">
    <div style="flex:1.1;min-width:0;position:relative;min-height:320px;">
      <div data-element="1" data-type="image" data-asset-key="{{imageKey}}" data-image-prompt="{{imagePrompt}}" data-image-kind="photo" data-border-radius="8" data-border data-border-width="1" data-border-color="{{divider}}" data-border-style="solid" data-z-index="12" style="position:absolute;inset:0;border-radius:8px;border:1px solid {{divider}};z-index:12;overflow:hidden;"></div>
    </div>
    <div style="flex:1;min-width:0;display:flex;flex-direction:column;justify-content:center;gap:18px;">
      <div data-element="1" data-type="text" data-font-size="15" data-font-family="{{fontBody}}" data-color="{{muted}}" data-line-height="1.55" data-placement="left-top" data-z-index="30" style="width:100%;font-size:15px;font-family:{{fontBody}},sans-serif;color:{{muted}};line-height:1.55;z-index:30;text-wrap:pretty;overflow-wrap:anywhere;">{{caption}}</div>
...
export const TEAM_STRIP = `<section id="slide" data-page-id="{{pageId}}" data-bg="{{background}}" style="width:1000px;height:562.5px;position:relative;overflow:hidden;background:{{background}};box-sizing:border-box;padding:44px 56px;font-family:{{fontTitle}},sans-serif;">
  ...
  <div style="display:flex;gap:36px;margin-top:40px;">
    <div style="flex:1;min-width:0;">
      <div data-element="1" data-type="image" data-asset-key="{{tm1.imageKey}}" data-image-prompt="{{tm1.imagePrompt}}" data-image-kind="cutout" data-border-radius="36" data-border data-border-width="2" data-border-color="{{secondary}}" data-border-style="solid" data-z-index="12" style="width:72px;height:72px;border-radius:36px;border:2px solid {{secondary}};z-index:12;overflow:hidden;"></div>
    ...
    <div style="flex:1;min-width:0;">
      <div data-element="1" data-type="image" data-asset-key="{{tm2.imageKey}}" data-image-prompt="{{tm2.imagePrompt}}" data-image-kind="cutout" data-border-radius="36" data-border data-border-width="2" data-border-color="{{secondary}}" data-border-style="solid" data-z-index="12" style="width:72px;height:72px;border-radius:36px;border:2px solid {{secondary}};z-index:12;overflow:hidden;"></div>
    ...
    <div style="flex:1;min-width:0;">
      <div data-element="1" data-type="image" data-asset-key="{{tm3.imageKey}}" data-image-prompt="{{tm3.imagePrompt}}" data-image-kind="cutout" data-border-radius="36" data-border data-border-width="2" data-border-color="{{secondary}}" data-border-style="solid" data-z-index="12" style="width:72px;height:72px;border-radius:36px;border:2px solid {{secondary}};z-index:12;overflow:hidden;"></div>
...
export const TIMELINE_PULSE = `<section id="slide" data-page-id="{{pageId}}" data-bg="{{background}}" style="width:1000px;height:562.5px;position:relative;overflow:hidden;background:{{background}};box-sizing:border-box;padding:44px 56px;font-family:{{fontTitle}},sans-serif;">
  <div data-element="1" data-type="text" data-font-size="32" data-font-family="{{fontTitle}}" data-color="{{textOnLight}}" data-line-height="1.2" data-placement="left-top" data-bold data-z-index="30" style="width:888px;font-size:32px;font-family:{{fontTitle}},serif;font-weight:700;color:{{textOnLight}};line-height:1.2;z-index:30;text-wrap:balance;overflow-wrap:anywhere;">{{title}}</div>
  <div style="position:relative;margin-top:72px;width:888px;">
    <div data-element="1" data-type="shape" data-shape-type="rect" data-fill="{{divider}}" data-z-index="8" style="position:absolute;left:0;top:6px;width:888px;height:2px;background:{{divider}};z-index:8;"></div>
    <div style="display:flex;gap:0;position:relative;z-index:10;">
...
export const NARRATIVE_COLUMN = `<section id="slide" data-page-id="{{pageId}}" data-bg="{{background}}" style="width:1000px;height:562.5px;position:relative;overflow:hidden;background:{{background}};box-sizing:border-box;padding:44px 56px;font-family:{{fontTitle}},sans-serif;">
  <div style="display:flex;gap:48px;">
    <div style="flex:1.65;min-width:0;">
      <div data-element="1" data-type="text" data-font-size="32" data-font-family="{{fontTitle}}" data-color="{{textOnLight}}" data-line-height="1.2" data-placement="left-top" data-bold data-z-index="30" style="width:100%;font-size:32px;font-family:{{fontTitle}},serif;font-weight:700;color:{{textOnLight}};line-height:1.2;z-index:30;text-wrap:balance;overflow-wrap:anywhere;">{{title}}</div>
